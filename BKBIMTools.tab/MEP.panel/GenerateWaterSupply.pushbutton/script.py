...
Cold and/or Hot Water supply pipes to a point you click - through the
ceiling, under the floor, or inside the wall. Highlights the room in green
...
def _pick_pipe_type():
    ...
    return forms.SelectFromList.show(
        names, title=u"Pick the pipe type to route Water Supply with", multiselect=False)
