...
__doc__ = u"""Export materials with appearance class, category and description; flags which are used in the model."""

from bkbim.boq import service
service.run_export(['Materials'], default_name='BKDesigns_Materials')
