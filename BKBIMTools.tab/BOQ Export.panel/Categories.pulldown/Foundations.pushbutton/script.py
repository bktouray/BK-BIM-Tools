...
__doc__ = u"""Export structural foundations/footings: mark, family/type, volume, mass, length and material."""

from bkbim.boq import service
service.run_export(['Foundations'], default_name='BKDesigns_Foundations')
