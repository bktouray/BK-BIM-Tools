...
__doc__ = u"""Place wall-hosted windows from a CAD layer. The distance
between each pair of parallel lines sets the opening width; pick the family
type, host level and lintel height.
"""
...
from bkbim.automation import opening_tool

opening_tool.run(revit.doc, DB.BuiltInCategory.OST_Windows, "Window",
                 default_width_mm=1200, default_lintel_mm=2100,
